...
const app = Vue.createApp({
    data() {
        return {
            ...
            posts: [
                { id: 'not-all-runs-equal-3', title: 'Not All Runs are Created Equal, Part 3', author: 'A. Kline', date: '07/29/2022', description: 'How can the formula weighted run differential, a metric designed for comparing teams across different environments, by improved upon?', url: '/posts/2022-07-29/not-all-runs-equal-3' },
